...
search_space = [
    ...
    Categorical(['relu', 'sigmoid', 'elu', 'selu', 'softplus', 'softsign', 'hard_sigmoid'], name='activation1'),
    Categorical(['relu', 'sigmoid', 'elu', 'selu', 'softplus', 'softsign', 'hard_sigmoid'], name='activation2'),
    Categorical(['relu', 'sigmoid', 'elu', 'selu', 'softplus', 'softsign', 'hard_sigmoid'], name='activation3'),
    Categorical(['relu', 'sigmoid', 'elu', 'selu', 'softplus', 'softsign', 'hard_sigmoid'], name='activation4'),
    Categorical(['relu', 'sigmoid', 'elu', 'selu', 'softplus', 'softsign', 'hard_sigmoid'], name='activation5'),
    # Integer(1, 4, name='num_layers'), #  1, 4 testing for range of layers
    Categorical([5], name='num_layers'),
    Categorical(['GRU', 'LSTM', 'BiGRU', 'BiLSTM'], name='layer_type1'),
    Categorical(['GRU', 'LSTM', 'BiGRU', 'BiLSTM'], name='layer_type2'),
    Categorical(['GRU', 'LSTM', 'BiGRU', 'BiLSTM'], name='layer_type3'),
    Categorical(['GRU', 'LSTM', 'BiGRU', 'BiLSTM'], name='layer_type4'),
    Categorical(['GRU', 'LSTM', 'BiGRU', 'BiLSTM'], name='layer_type5'),
